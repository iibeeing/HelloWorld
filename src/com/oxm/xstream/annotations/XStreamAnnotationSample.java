package com.oxm.xstream.annotations;
...
public class XStreamAnnotationSample {
    ...
    public static void objectToXml()throws Exception{
    	User user = getUser();
        FileOutputStream fs = new FileOutputStream("D:\\XStreamAnnotationSample.xml");
    ...
    public static User xmlToObject()throws Exception{
    	FileInputStream fis = new FileInputStream("D:\\XStreamAnnotationSample.xml");
