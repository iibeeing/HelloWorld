...
public class Directory {
	...
	public static void MoveFolderAndFileWithSelf(String from, String to) throws Exception {
		try {
			...
			if(dir.exists()){
				System.out.println(dir.getName() + " 文件存在");
			}
			// 目标
	...
	public static void main(String[] args) throws Exception {
		...
		//Directory databean=new Directory();
		//File fl=new File("F:\\111\\222\\333\\444\\");
		//fl.mkdirs();//可以直接建立多级目录
		//Directory.MoveFolderAndFileWithSelf("C:\\w11k.bmp","D:\\photo");
		//databean.MoveFolderAndFileWithSelf("F:\\test","J:\\J\\www");
		String bak = "D:\\photo\\w11k-" + CommonUtil.getDateLong2() + ".bmp";
		Directory.CopySingleFile("C:\\w11k.bmp",bak);
