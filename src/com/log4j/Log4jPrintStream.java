...
public class Log4jPrintStream extends PrintStream {
	...
	/*
	 * public void println(boolean x) { log.debug(Boolean.valueOf(x)); }
	 * 
	 * 
	 * public void println(char x) { log.debug(Character.valueOf(x)); }
	 * 
	 * 
	 * public void println(char[] x) { log.debug(x == null ? null : new
	 * String(x)); }
	 * 
	 * 
	 * public void println(double x) { log.debug(Double.valueOf(x)); }
	 * 
	 * 
	 * public void println(float x) { log.debug(Float.valueOf(x)); }
	 */
